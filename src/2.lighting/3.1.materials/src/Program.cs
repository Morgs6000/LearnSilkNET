...
public class Program
{
    ...
    private static void OnLoad()
    {
        ...
        // --------------------------------------------------
        _lightingShader = new Shader(_gl, "src/materials.vs", "src/materials.fs");
    ...
    private static void OnRender(double deltaTime)
    {
        ...
        // propriedades da luz
        Vector3 lightColor;
        lightColor.X = MathF.Sin((float)Glfw.GetApi().GetTime() * 2.0f);
        lightColor.Y = MathF.Sin((float)Glfw.GetApi().GetTime() * 0.7f);
        lightColor.Z = MathF.Sin((float)Glfw.GetApi().GetTime() * 1.3f);
