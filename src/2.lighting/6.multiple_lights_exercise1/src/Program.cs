...
public class Program
{
    ...
    private static Vector3[] _pointLightPositions =
    {
    ...
    private static void OnLoad()
    {
        ...
        // --------------------------------------------------
        _lightingShader = new Shader(_gl, "src/multiple_lights.vs", "src/multiple_lights.fs");
    ...
    private static void OnRender(double deltaTime)
    {
        ...
        if (_atmospher == Atmospheres.DESERT)
        {
            ...
            _lightingShader.SetVec3("pointLights[2].ambient", pointLightColors[1] * 0.1f);
            _lightingShader.SetVec3("pointLights[2].diffuse", pointLightColors[1]);
            _lightingShader.SetVec3("pointLights[2].specular", pointLightColors[1]);
            ...
            _lightingShader.SetVec3("pointLights[3].ambient", pointLightColors[1] * 0.1f);
            _lightingShader.SetVec3("pointLights[3].diffuse", pointLightColors[1]);
            _lightingShader.SetVec3("pointLights[3].specular", pointLightColors[1]);
        ...
        if (_atmospher == Atmospheres.HORROR)
        {
            ...
            _lightingShader.SetVec3("pointLights[2].specular", pointLightColors[1]);
            _lightingShader.SetFloat("pointLights[2].constant", 1.0f);
            _lightingShader.SetFloat("pointLights[2].linear", 0.22f);
            _lightingShader.SetFloat("pointLights[2].quadratic", 0.20f);
    ...
    private static void ProcessInput()
    {
        ...
        if (_keyboard.IsKeyPressed(Key.Number1))
        {
            _atmospher = Atmospheres.DESERT;
        }
        if (_keyboard.IsKeyPressed(Key.Number2))
        {
            _atmospher = Atmospheres.FACTORY;
        }
        if (_keyboard.IsKeyPressed(Key.Number3))
        {
            _atmospher = Atmospheres.HORROR;
        }
        if (_keyboard.IsKeyPressed(Key.Number4))
        {
