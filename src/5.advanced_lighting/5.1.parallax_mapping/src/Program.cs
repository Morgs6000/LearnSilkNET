...
public class Program
{
    ...
    private static float _heightScale = 0.1f;
    ...
    private static uint _heightMap;
    ...
    private static void OnLoad()
    {
        ...
        // --------------------------------------------------
        _shader = new Shader(_gl, "src/parallax_mapping.vs", "src/parallax_mapping.fs");
    ...
    private static void OnRender(double deltaTime)
    {
        ...
        _gl.BindTexture(TextureTarget.Texture2D, _heightMap);
    ...
    private static void ProcessInput()
    {
        ...
        if (_primaryKeyboard.IsKeyPressed(Key.E))
        {
