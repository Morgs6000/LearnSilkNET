...
public class Program
{
    ...
    private static void OnRender(double deltaTime)
    {
        ...
        Matrix4x4 tranform = Matrix4x4.Identity;
        tranform *= Matrix4x4.CreateTranslation(new Vector3(0.5f, -0.5f, 0.0f)); // inverti a ordem
        tranform *= Matrix4x4.CreateFromAxisAngle(Vector3.Normalize(new Vector3(0.0f, 0.0f, 1.0f)), (float)Glfw.GetApi().GetTime()); // inverti a ordem
