...
public class Program
{
    ...
    private static uint _transparentVAO, _transparentVBO;

    private static uint _cubeTexture;
    private static uint _floorTexture;
    private static uint _transparentTexture;

    // locais de vegetação transparente
    // --------------------------------------------------
    private static List<Vector3> _vegetation = new List<Vector3>()
    {
    ...
    private static void OnLoad()
    {
        ...
        // --------------------------------------------------
        _shader = new Shader(_gl, "src/blending.vs", "src/blending.fs");
