...
public class Program
{
    ...
    private static Shader _shaderSingleColor = null!;
    ...
    private static void OnLoad()
    {
        ...
        // --------------------------------------------------
        _shader = new Shader(_gl, "src/stencil_testing.vs", "src/stencil_testing.fs");
        _shaderSingleColor = new Shader(_gl, "src/stencil_testing.vs", "src/stencil_single_color.fs");
